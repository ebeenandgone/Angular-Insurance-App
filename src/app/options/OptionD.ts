  ...
  */
  validForOption(){
    ...
    return this.getMaxLoanValue() >= this.getLoanAmount() &&
      (this.getLoanLength() == 10 || this.getLoanLength() == 30) &&
      this.isAccountRequired() == false && this.isDepositEnough() == true;
